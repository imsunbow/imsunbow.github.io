...
return Controller.extend("zgwe1fi0002.zgwe1fi0002.controller.DunningView", {
        ...
        _buildDunningHtml: function (oData) {
            ...
            return `
<div style="font-family:'Malgun Gothic',AppleGothic,sans-serif;max-width:680px;margin:0 auto;padding:36px 44px;color:#333;font-size:14px;box-sizing:border-box">
        ...
        _openDunningDialog: function (oData) {
            ...
            const oDialog = new Dialog({
                ...
                beginButton: new Button({
                    text: "인쇄", icon: "sap-icon://print", type: "Emphasized",
                    press: () => {
                        const oPrintWin = window.open("", "_blank", "width=750,height=700");
